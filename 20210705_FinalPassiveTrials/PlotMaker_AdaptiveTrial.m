    ...
    for nuIndex = 1:length(nuArray)
        ...
        for gammaIndex = 1:length(gammaArray)
            ...
            for N0Index = 1:length(N0Array)
                ...
                plot(1:Rounds, TrialStats(:,7),'-','Linewidth',2,'Color',[1 0.1 0.1])
                plot(1:Rounds, TrialStats(:,8),'-','Linewidth',2,'Color',[0.6 0.1 1])
                leg = {
                    'Init Photons'
                ...
                grid off
                colormap parula
                plot(1:Rounds, TrialStats(:,3),'-','Linewidth',3,'Color',[0 0 0])
                plot(1:Rounds, TrialStats(:,4),'-','Linewidth',2,'Color',[1 0.1 0.1])
                plot(1:Rounds, TrialStats(:,5),'-','Linewidth',2,'Color',[0.6 0.1 1])
                leg = {
                    'Loop Photons'
