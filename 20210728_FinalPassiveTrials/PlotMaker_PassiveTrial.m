        ...
        for gammaIndex = 1:length(gammaArray)
            ...
            for N0Index = 1:length(N0Array)
                ...
                for epsIndex = 1:length(epsArray)
                    ...
                    plot(1:Rounds, TrialStats(:,6),'-','Linewidth',2,'Color',[0 0.5 1])
                    plot(1:Rounds, TrialStats(:,7),'-','Linewidth',2,'Color',[0 1 0.5])
                    leg = {
                        'Init Photons'
                    ...
                    plot(1:Rounds, TrialStats(:,3),'-','Linewidth',2,'Color',[0 0.5 1])
                    plot(1:Rounds, TrialStats(:,4),'-','Linewidth',2,'Color',[0 1 0.5])
                    leg = {
                        'Loop Photons'
